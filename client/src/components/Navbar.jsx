...
export default function Navbar({ activeTab, setActiveTab, onOpenAuth }) {
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-100 shadow-xs">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <span className="font-black text-xl tracking-tight text-slate-900">
                  Vua Hoàn <span className="text-orange-600">Tiền</span>
                </span>
                  ...
                  <div className="absolute right-0 mt-2 w-80 bg-white rounded-3xl shadow-2xl border border-slate-100 p-4 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
                    ...
                    <div className="space-y-1 text-sm font-semibold text-slate-700">
                      ...
                      >
                        ...
                        <span>Cách Vua Hoàn Tiền hoạt động</span>
                      </button>
      ...
      {/* Category sub-navigation bar (ShopBack style) */}
      <nav className="border-t border-slate-100 bg-white/90 hidden md:block">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center gap-6 py-2 text-xs font-semibold text-slate-600 overflow-x-auto">
          <button
            type="button"
            onClick={() => {
              setActiveTab('home');
            ...
            className="flex items-center gap-1.5 font-bold text-orange-600 hover:text-orange-700 shrink-0 cursor-pointer"
          >
            <Menu className="w-3.5 h-3.5" />
            <span>Tất cả danh mục</span>
          </button>
          <a href="#popular-stores" className="hover:text-orange-600 transition-colors shrink-0">Thương hiệu nổi bật</a>
          <a href="#hot-deals" className="hover:text-orange-600 transition-colors flex items-center gap-1 shrink-0">
            <Sparkles className="w-3 h-3 text-amber-500" />
            <span>Hot Deals Hoàn Tiền</span>
          </a>
          <a href="#calculator" className="hover:text-orange-600 transition-colors shrink-0">Bảng tỷ lệ hoàn</a>
          <a href="#how-it-works" className="hover:text-orange-600 transition-colors shrink-0">Cách hoạt động</a>
          <a href="#faq" className="hover:text-orange-600 transition-colors shrink-0">Hỗ trợ & Đối soát</a>
          <div className="ml-auto flex items-center gap-2 shrink-0">
            <span className="text-[11px] font-bold text-emerald-700 bg-emerald-50 px-2.5 py-0.5 rounded-full border border-emerald-200 flex items-center gap-1">
              <Check className="w-3 h-3 text-emerald-600" />
              Chi trả ngân hàng 24/7 trong 3 ngày
            </span>
          </div>
        </div>
      </nav>
